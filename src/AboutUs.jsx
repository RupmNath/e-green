...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to E Green, where eye meets green serenity!</p>
      <p className="about-us-content">
        At E Green, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of 
